...
if __name__ == "__main__":
    ...
    dicts = torch.load("tv_checkpoint_epoch50_sparse.pt")
    ...
    model = PDN(input_dimension=input_dimension,
                            ...
                            n_primal=n_primal, n_dual=n_dual,
                            n_iterations=n_iterations).cuda()
    dicts = torch.load("lpd_checkpoint_epoch50_sparse.pt")
    ...
    for test_data in tqdm(test_dataloader):
        ...
        observation = utils.add_noise(ground_truth, n_detectors=543,
                                    n_angles=60, input_dimension=362, photons_per_pixel=1000.0).cuda()
    ...
    # plt.savefig("figures/TV_LPD_comparison.png")
    ...
    # plt.tight_layout(rect=[0, 0.05, 1, 0.95])
    # plt.savefig("figures/TV_LPD_difference.png")