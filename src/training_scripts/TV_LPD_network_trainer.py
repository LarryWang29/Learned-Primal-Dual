"""
This script is used to train the Total Variation Learned Primal Dual network, a custom variant of 
the standard LPD model, inspired by Chambolle-Pock algorithm for Total Variation (exact algorithm 
can be found at https://iopscience.iop.org/article/10.1088/0031-9155/57/10/3065).
...
Example usage:
``python src/training_scripts/TV_LPD_network_trainer.py default # Trains the model under default geometry``
"""
...
def train_network(input_dimension=362, n_detectors=543,
    ...
    """
    This function trains the Total Variance Learned Primal-Dual network on the training dataset.
